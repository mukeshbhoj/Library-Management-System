...
if($session->param('LIBRARIAN'))
{
	...
	if(Check_add_mem::check_id($id))
	{
		...
		my $template3 = HTML::Template->new(filename => '/var/www/project/html/su/su_member_search.tmpl'); 
	...
	{
		my $template5 = HTML::Template->new(filename => '/var/www/project/html/su/su_member_search.tmpl'); 
